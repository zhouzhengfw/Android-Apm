package com.loopnow.apm.battery;
...
import com.loopnow.apm.startup.LauncherHelpProvider;
...
public class BatteryStatsTracker implements ITracker {
    ...
    public void destroy(Application application) {
        Apm.getInstance().removeActivityLifecycleCallbacks(mSimpleActivityLifecycleCallbacks);
    }
